...
namespace  Nadiiaz\Install\Controller;

use  Nadiiaz\Framework\Http\Response\Html;

class Index implements \ Nadiiaz\Framework\Http\ControllerInterface
{
    private \ Nadiiaz\Framework\Database\Adapter\AdapterInterface $adapter;

    private \ Nadiiaz\Framework\Http\Response\Html $html;

    /**
     * @param \ Nadiiaz\Framework\Database\Adapter\AdapterInterface $adapter
     * @param \ Nadiiaz\Framework\Http\Response\Html $html
     */
    public function __construct(
        \ Nadiiaz\Framework\Database\Adapter\AdapterInterface $adapter,
        \ Nadiiaz\Framework\Http\Response\Html $html
    ) {
